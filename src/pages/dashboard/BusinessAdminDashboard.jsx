...
const teamActivity = [
  {
    id: 'a-1',
    who: 'Devon Lane',
    action: 'created campaign “Spring Sale”',
    when: '14 min ago',
  },
  {
    id: 'a-2',
  ...
  },
  {
    id: 'a-3',
    who: 'You',
    action: 'approved 2 pending campaigns',
    when: 'Today, 09:14',
  },
  {
    id: 'a-4',
    who: 'Marco Diaz',
    action: 'imported 312 new contacts',
    when: 'Yesterday',
  },
];
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-5 lg:grid-cols-3">
        <div className="lg:col-span-2">
          <SectionCard
            title="Performance"
            hint="Engagement across all campaigns — last 12 weeks"
          >
            <MiniBars
              values={[42, 55, 47, 64, 58, 71, 66, 78, 73, 86, 79, 91]}
            />
          </SectionCard>
        </div>
        ...
        <SectionCard title="Usage limits" hint="Plan: Growth">
          ...
          <Link
            to="/app/billing"
            className="mt-4 inline-block text-xs font-semibold text-indigo-600 hover:underline dark:text-indigo-300"
          >
            View billing & limits →
          </Link>
        </SectionCard>
        ...
        <DataTable
          columns={[
            ...
            { key: 'click', label: 'Click rate' },
            {
              ...
              label: 'Status',
              render: (row) => (
                <Badge tone={tone[row.status] || 'slate'}>
                  {row.status}
                </Badge>
              ),
            },
